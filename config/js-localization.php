    ...
    */
    'messages' => [
        'app'   => [
            ...
            'discover_suggestions_content'
        ],
        'auth'  => [
            'medlib_title',
            'medlib_register_message',
            'failed',
            'throttle',
            'btn' => [
                'login',
            ...
            'validation' => [
                'validation_code_does_not_exist',
                'validation_code_has_expired',
                'account_has_been_activated',
                'need_validation_code'
            ],
            'user_information_login',
            'user_title_login',
            'account_dont_have',
            'available',
            'unavailable',
            ...
            'friends_remove_request',
            'friends_dont_have', 'settings'
        ],
        'emails' => [
            'title_confirmation_email',
            'title_welcome_message',
            'content_title_confirmation_email',
            'content_title_password_reset',
            'content_title_confirmation_success',
            'login_user_manually',
            'activate_email_before_using',
            'thank_you_for_using',
            'login_user_now',
            'send_friend_request'
        ],
