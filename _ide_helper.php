 ...
 * Generated for Laravel 0.2.11-dev on 2017-03-13.
 *
...
namespace Yaz\Facades {
    ...
    class Yaz {
        ...
        {
            //Method inherited from \Yaz\Factory\YazFactory            
        ...
        {
            //Method inherited from \Yaz\Factory\YazFactory            
            return \Yaz\YazQuery::where($query);
        }
         ...
         * @return \Yaz\Factory\YazRecords 
         * @static 
         */
        public static function all($RecordsMode = null, $syntaxMode = 'marc21')
        {
            //Method inherited from \Yaz\Factory\YazFactory            
            return \Yaz\YazQuery::all($RecordsMode, $syntaxMode);
        }
        ...
        {
            //Method inherited from \Yaz\Factory\YazFactory            
            return \Yaz\YazQuery::first($RecordsMode, $syntaxMode);
        }
