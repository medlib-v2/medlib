;(function(){
	...
	* @type {Object}
	*/
	jQuery.fn.beList.CookiesService = {};
	...
	*/
	jQuery.fn.beList.CookiesService.setCookie = function(name, value, expiration){
	...
	* @return {?string}
	*/
	jQuery.fn.beList.CookiesService.getCookie = function(cookieName){
	...
	* @param {number} expiration - cookie expiration in minutes (-1 = cookies expire when browser is closed)
	*/
	jQuery.fn.beList.CookiesService.saveCookies = function(statuses, cookieName, expiration){
		...
		jQuery.fn.beList.CookiesService.setCookie(cookieName, json, expiration);
	};
	...
	*/
	jQuery.fn.beList.CookiesService.restoreCookies = function(cookieName){
		
		var json
			,statuses = [];
		
		//get json from cookies
		json = jQuery.fn.beList.CookiesService.getCookie(cookieName);
