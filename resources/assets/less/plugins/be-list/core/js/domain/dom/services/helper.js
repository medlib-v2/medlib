;(function(){
	...
	* @type {Object} 
	*/
	jQuery.fn.beList.HelperService = {};
	...
	*/
	jQuery.fn.beList.HelperService.getOuterHtml = function(el){
	...
	* @return {string}
	*/
	jQuery.fn.beList.HelperService.removeCharacters = function(text, regex){
	...
	* @return {Date}
	*/
	jQuery.fn.beList.HelperService.formatDateTime = function(datetime, format){
