(function(){//+
	...
	*/
	var getPaths = function(context, paths){
		...
		if(jqPath){
			...
			path = new jQuery.fn.beList.PathModel(jqPath, 'text');
			paths.push(path);
		}
	};
	...
	* @param {Object} context
	*/
	jQuery.fn.beList.controls.RadioButtonsFilter = function(context){
	...
	*/
	jQuery.fn.beList.controlTypes['radio-buttons-filters'] = {
