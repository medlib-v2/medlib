(function(){//+
	...
	*/
	var getStatus = function(context, isDefault){
		...
		data = new jQuery.fn.beList.controls.CheckboxGroupFilterDTO(pathGroup);
	...
	* @param {Object} context
	*/
	jQuery.fn.beList.controls.CheckboxGroupFilter = function(context){
	...
	*/
	jQuery.fn.beList.controlTypes['checkbox-group-filter'] = {
