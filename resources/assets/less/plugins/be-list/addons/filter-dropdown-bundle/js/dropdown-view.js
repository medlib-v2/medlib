;(function(){
	...
	*/
	var getStatus = function(context, isDefault){
		...
		data = new jQuery.fn.beList.controls.DropdownFilterDTO($span.attr('data-path'), $span.attr('data-type'));
	...
	* @param {Object} context
	*/
	jQuery.fn.beList.controls.FilterDropdown = function(context){
	...
	*/
	jQuery.fn.beList.controlTypes['filter-drop-down'] = {
