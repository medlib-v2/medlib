(function(){//+
	...
	*/
	var getStatus = function(context, isDefault){
		...
		data = new jQuery.fn.beList.controls.BootSortDropdownDTO(
			$btn.attr('data-path')
			,$btn.attr('data-type')
			,$btn.attr('data-order')
	...
	* @param {Object} context
	*/
	jQuery.fn.beList.controls.BootSortDropdown = function(context){
	...
	*/
	jQuery.fn.beList.controlTypes['boot-sort-drop-down'] = {
