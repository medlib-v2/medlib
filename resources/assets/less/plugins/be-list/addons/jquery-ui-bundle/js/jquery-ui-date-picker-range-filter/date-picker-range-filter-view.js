;(function(){
	...
	var getStatus = function(context, isDefault){
		...
		data = new jQuery.fn.beList.controls.DatePickerRangeFilterDTO(dataPath, context.params.dateTimeFormat, prevDate, nextDate);
	...
	var getPaths = function(context, paths){
		...
		if(jqPath){
			...
			path = new jQuery.fn.beList.PathModel(jqPath, 'datetime');
			paths.push(path);
		}	
	};
    ...
    var getDefaultDate = function(context, dateValue){
        ...
        if(dateValue){
            ...
            if(dateValue === 'today'){
                ...
                date = jQuery.fn.beList.HelperService.formatDateTime(dateValue, context.params.dateTimeFormat);
            }
        }
	 ...
	 * @param {Object} context
	 */
	jQuery.fn.beList.controls.DatePickerRangeFilter = function(context){
	 ...
	 */
	jQuery.fn.beList.controlTypes['date-picker-range-filter'] = {
