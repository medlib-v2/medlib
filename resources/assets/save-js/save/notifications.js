(function (factory) {
    ...
    "use strict";
    /**
     * Public - options to over-ride with $.Notification.options in "add"
     * @type {{position: string, class_name: string, fade_in_speed: string, fade_out_speed: number, time: number}}
     */
    var defaults = {
        position: '',
    ...
    Notification.prototype = {
        ...
        itemCount: 0,
        isSetup: 0,
        templateClose: '<a class="notification-close" href="#" tabindex="1">Close Notification</a>',
        templateTitle: '<span class="notification-title">[[title]]</span>',
        templateItem: '<div id="notification-item-[[number]]" class="notification-item-wrapper [[item_class]]" style="display:none" role="alert"><div class="notification-top"></div><div class="notification-item">[[close]][[image]]<div class="[[class_name]]">[[title]]<p>[[text]]</p></div><div style="clear:both"></div></div><div class="notification-bottom"></div></div>',
        templateWrap: '<div id="notification-notice-wrapper"></div>',
        ...
        add: function (params) {
            ...
            var imageStr = (image != '') ? '<img src="' + image + '" class="notification-image" />' : '',
            ...
            var item = $('#notification-item-' + self.itemCount);
         ...
         * @private
         * @param {Integer} uniqueId The ID of the element that was just deleted, use it for a callback
         * @param {Object} e The jQuery element that we're going to perform the remove() action on
         * @param {Boolean} manualClose Did we close the Notification dialog with the (X) button
         */
        countRemoveWrapper: function(uniqueId, e, manualClose){
         ...
         * @param {Integer} uniqueId The id of the element to remove
         * @param {Object} params An optional list of params to set fade speeds etc.
         * @param {Boolean} unbindEvents Unbind the mouseenter/mouseleave events if they click (X)
         */
        fade: function(e, uniqueId, params, unbindEvents){
            var params = params || {},
         ...
         * @param {Integer} uniqueId The ID used to delete a specific notification
         ...
         */
        removeSpecific: function(uniqueId, params, e, unbindEvents){

            if(!e){
                var e = $('#notification-item-' + uniqueId);
            }
         ...
         */
        restoreItemIfFading: function(e, uniqueId){
         ...
         * @param {Integer} uniqueId The ID of the element
         */
        setFadeTimer: function(e, uniqueId){
            var self = this,
        ...
        stop: function(params){
             ...
             * @type {Function}
             */
            var beforeClose = ($.isFunction(params.beforeClose)) ? params.beforeClose : function(){},
                afterClose = ($.isFunction(params.afterClose)) ? params.afterClose : function(){};

            var wrap = $('#notification-notice-wrapper');
            beforeClose(wrap);
...
var Medlib = (function () {
    'use strict';
    Medlib.Notification = function(element, options){
        $.Notification.options = options;

        $(element).click(function(){
            $.extend($.Notification.options, { position: 'top-left' });
