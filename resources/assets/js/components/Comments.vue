<template>
    <ul class="post-comments mt-sm">
        <li>
            <span class="thumb-xs avatar pull-left mr-sm"><img class="img-circle" :src="user.user_avatar" :alt="user.full_name"></span>
            <div class="comment-body">
                <form  @submit.prevent="submit">
                    <div class="form-group" :class="hasError">
                        <input class="form-control input-sm" name="comment" type="text" placeholder="Write your comment..." autocomplete="off">
