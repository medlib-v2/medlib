                    ...
                    <div class="footer-block col-xs-12 col-sm-3">
                        ...
                        <div class="toggle-footer">
                            <ul class="list-unstyled">
                                ...
                                <li><a href="#/site/feed">RSS Feed</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="footer-block col-xs-12 col-sm-3">
                    ...
                    <div class="footer-block col-xs-12 col-sm-3">
                        ...
                        <div class="toggle-footer">
                            <ul class="list-unstyled">
                                ...
                                <li><a href="#/blog/resources">Resource List</a></li>
        ...
        <div class="bottom-footer">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="pull-left">
                            &copy; {{ year }} <router-link :to="{ name: 'home' }" rel="nofollow"><h1>MedLib Project - EIP ETNA.</h1></router-link> |
                            <a href="#/site/licenses">Licenses</a> |
