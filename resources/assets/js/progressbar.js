...
;(function(root, factory) {
  ...
  ProgressBar.version = '0.2.0';

  var Settings = ProgressBar.settings = {
    minimum: 0.08,
    easing: 'ease',
    positionUsing: '',
    speed: 200,
  ...
  ProgressBar.set = function(n) {
    ...
    queue(function(next) {
      ...
      if (Settings.positionUsing === '') Settings.positionUsing = ProgressBar.getPositioningCSS();
  ...
  ProgressBar.isStarted = function() {
    return typeof ProgressBar.status === 'number';
  };
  ...
  ProgressBar.start = function() {
    if (!ProgressBar.status) ProgressBar.set(0);
  ...
  ProgressBar.done = function(force) {
    if (!force && !ProgressBar.status) return this;
  ...
  ProgressBar.trickle = function() {
    return ProgressBar.inc(Math.random() * Settings.trickleRate);
  };
  ...
  ProgressBar.render = function(fromStart) {
    if (ProgressBar.isRendered()) return document.getElementById('ProgressBar');
    ...
    if (parent != document.body) {
      addClass(parent, 'ProgressBar-custom-parent');
    }
