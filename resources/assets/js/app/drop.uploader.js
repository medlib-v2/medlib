(function (factory) {
    ...
    $.fn.dropUploader = function(options) {
        options = $.extend({
            ...
            browse_text: 'Browse',
            browse_css_class: 'file-browse',
            browse_css_selector: 'file-browse',
        ...
        this.each(function(i, val) {
            ...
            $(v).wrap('<div id="' + uploader_id + '" class="drop-uploader drop-zone"></div>');
            $(v).before('<div class="text-wrapper">' + options.uploader_icon + ' <span class="text">' + options.uploader_text + ' <a href="#" class="' + options.browse_css_class + ' ' + options.browse_css_selector + '">' + options.browse_text + '</a></span></div>');
