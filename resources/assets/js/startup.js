...
(function($){
    ...
    /**
     * MedlibSettingsBundle provides a convenient way to access Medlib related localStorage options.
     * Settings should be explicitly saved by calling save() method after changing some property
     * @constructor
     * @example
     * MedlibSettings.set('nav-static', false);
     * MedlibSettings.save();
     */
    var MedlibSettingsBundle = function(){
        var defaultSettings =  {
            /**
        ...
        this.settingName = 'medlib-app-settings';
        this._settings = JSON.parse(localStorage.getItem(this.settingName)) || defaultSettings;
    };

    MedlibSettingsBundle.prototype.save = function(){
        localStorage.setItem(this.settingName, JSON.stringify(this._settings));
        return this;
    };

    MedlibSettingsBundle.prototype.get = function(key){
        return this._settings[key];
    };

    MedlibSettingsBundle.prototype.set = function(key, value){
