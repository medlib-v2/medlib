...
describe("Other Mobile Devices", () => {
    ...
    describe("BlackBerry 10", () => {
        ...
        it("should not be a Chrome device", () => {
            expect(mobile.other.chrome).not.toBe(true);
        });

        it("should be a BlackBerry 10 device", () => {
            expect(mobile.other.blackberry10).toBe(true);
        });

        it("should not be a BlackBerry device", () => {
    ...
    describe("BlackBerry", () => {
        ...
        it("should not be a BlackBerry 10 device", () => {
    ...
    describe("Opera Mini", () => {
        ...
        it("should be an Opera Mini device", () => {
    ...
    describe("Chrome", () => {
        ...
        it("should not be a Firefox OS device", () => {
