(function(){//+
	...
	*/
	var getPaths = function(context, paths){
		...
		if(context.params.path){
			...
			path = new jQuery.fn.beList.PathModel(context.params.path, 'number');
			paths.push(path);
		}
	};
	...
	* @param {Object} context
	*/
	jQuery.fn.beList.controls.RangeSliderToggleFilter = function(context){
	...
	*/
	jQuery.fn.beList.controlTypes['range-filter'] = {
