(function(){
	...
	*/
	jQuery.fn.beList.controls.SortButtonDTO = function(dataPath, type, order, dateTimeFormat, ignore, isSelected){
	...
	* @constructor
	* @param {Array.<jQuery.fn.beList.controls.SortButtonDTO>} sortGroup
	*/
	jQuery.fn.beList.controls.SortButtonsGroupDTO = function(sortGroup){
