(function(){//+
    ...
    var getStatus = function(context, isDefault){
        ...
        data = new jQuery.fn.beList.controls.PaginationDTO(cpage, itemsPerPage);
    ...
    var Init = function(context){
        ...
        context.params = {
            ...
            view: new jQuery.fn.beList.controls.PaginationView(context.$control, context.controlOptions)
        };
     ...
     * @param {Object} context
     */
    jQuery.fn.beList.controls.Pagination = function(context){
