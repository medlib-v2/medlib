(function(){
	...
	*/
	var getStatus = function(context, isDefault){
		...
		data = new jQuery.fn.beList.controls.DropdownPaginationDTO($option.attr('data-number'));
	...
	* @param {Object} context
	*/
	jQuery.fn.beList.controls.ItemsPerPageSelect = function(context){
	...
	*/
	jQuery.fn.beList.controlTypes['items-per-page-select'] = {
