(function(){//+
	...
	*/
	var getStatus = function(context, isDefault){
		...
		data = new jQuery.fn.beList.controls.BootstrapPaginationDTO(cpage, itemsPerPage);
	...
	*/
	var Init = function(context){
		...
		context.params = {			
			view: new jQuery.fn.beList.controls.BootstrapPaginationView(context.$control, context.controlOptions)
		};		
	...
	* @param {Object} context
	*/
	jQuery.fn.beList.controls.BootstrapPagination = function(context){
	...
	*/
	jQuery.fn.beList.controlTypes['boot-pagination'] = {
