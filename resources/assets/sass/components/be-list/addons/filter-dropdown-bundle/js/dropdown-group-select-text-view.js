(function(){
	...
	*/
	var getStatus = function(context, isDefault){
		...
		data = new jQuery.fn.beList.controls.TextFilterDropdownGroupDTO(
			textGroup
			,context.params.mode
	...
	* @param {Object} context
	*/
	jQuery.fn.beList.controls.FilterDropdownGroupSelectText = function(context){
	...
	*/
	jQuery.fn.beList.controlTypes['dropdown-select-group-text-fitler'] = {
