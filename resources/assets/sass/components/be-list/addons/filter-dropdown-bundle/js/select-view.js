(function(){
	...
	*/
	var getStatus = function(context, isDefault){
		...
		data = new jQuery.fn.beList.controls.DropdownFilterDTO($option.attr('data-path'), $option.attr('data-type'));
	...
	* @param {Object} context
	*/
	jQuery.fn.beList.controls.FilterSelect = function(context){
	...
	*/
	jQuery.fn.beList.controlTypes['filter-select'] = {
