...
<td class="col-md-7 col-sm-7">
    ...
    <!--
    <div class="be-list-label" data-type="<strong>Page {current} {{ trans('search.txt.of') }} {pages}</strong>" data-control-type="pagination-info" data-control-name="paging" data-control-action="paging">
    </div> -->
