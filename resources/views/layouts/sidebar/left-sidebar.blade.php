            ...
            <div class="left-sidebar-scroll">
                <div class="left-sidebar-content">
                    <ul class="sidebar-elements">
                        ...
                        <li><a href="{{ route('dashboard.home') }}"><i class="icon fa fa-home"></i><span>Dashboard</span></a>
                        </li>
                        <li class="parent">
                            <a href="#"><i class="icon glyphicon glyphicon-briefcase"></i><span>UI Elements</span></a>
                            <ul class="sub-menu">
                        ...
                        <li class="parent"><a href="#charts.html"><i class="icon fa fa-pie-chart"></i><span>Charts</span></a>
                            <ul class="sub-menu">
                        ...
                        <li class="parent"><a href="#"><i class="icon glyphicon glyphicon-edit"></i><span>Forms</span></a>
                            <ul class="sub-menu">
                        ...
                        <li class="parent active open"><a href="#"><i class="icon fa fa-table"></i><span>Tables</span></a>
                            <ul class="sub-menu">
                        ...
                        <li class="parent"><a href="#"><i class="icon glyphicon glyphicon-th"></i><span>Pages</span></a>
                            <ul class="sub-menu">
                        ...
                        <li class="parent"><a href="#"><i class="icon fa fa-inbox"></i><span>Email</span></a>
                            <ul class="sub-menu">
                        ...
                        <li class="parent"><a href="#"><i class="icon fa fa-laptop"></i><span>Layouts</span></a>
                            <ul class="sub-menu">
                        ...
                        <li class="parent"><a href="#"><i class="icon fa fa-map-marker"></i><span>Maps</span></a>
                            <ul class="sub-menu">
