                ...
                <div class="tab-content">
                                ...
                                <div class="be-scroller">
                                    <div class="content">
                                        ...
                                        <div class="contact-list">
                                            <div class="user"><a href="#"><img src="{{ asset('images/people/a4.jpg') }}" alt="Avatar">
                                                    <div class="user-data2"><span class="status"></span><span class="name">Mike Bolthort</span></div></a></div>
                                            <div class="user"><a href="#"><img src="{{ asset('images/people/a5.jpg') }}" alt="Avatar">
                                                    <div class="user-data2"><span class="status"></span><span class="name">Maggie jackson</span></div></a></div>
                                            <div class="user"><a href="#"><img src="{{ asset('images/people/a6.jpg') }}" alt="Avatar">
                    ...
                    <div id="tab2" role="tabpanel" class="tab-pane tab-todo">
                        <div class="todo-container">
                            <div class="todo-wrapper">
                                <div class="be-scroller">
                                    <div class="todo-content"><span class="category-title">Today</span>
                                        <ul class="todo-list">
                                            <li>
                                                <div class="be-checkbox be-checkbox-sm"><span class="delete fa fa-trash-o"></span>
                            ...
                            <div class="bottom-input">
                                <input type="text" placeholder="Create new task..." name="q"><span class="fa fa-plus"></span>
                            </div>
                        </div>
                    </div>
