<div class="widget-events widget-left-panel">
	<div class="menu-list">
		<ul class="list-unstyled">
			...
			<li><a href="{{ url(Auth::user()->getUsername()) }}" class="btn menu-btn"><i class="fa fa-user" aria-hidden="true"></i>{{ trans('common.my_profile') }} </a></li>
			...
			<li><a href="{{ url(Auth::user()->getUsername().'/pages-groups') }}" class="btn menu-btn"><i class="fa fa-file-text" aria-hidden="true"></i>{{ trans('common.pages') }} <span class="event-circle pull-right">{{ Auth::user()->ownPages()->count() }}</span></a></li>

			<li><a href="{{ url(Auth::user()->getUsername().'/pages-groups') }}" class="btn menu-btn"><i class="fa fa-group" aria-hidden="true"></i>{{ trans('common.groups') }} <span class="event-circle pull-right">{{ Auth::user()->ownGroups()->count() }}</span></a></li>

			<li><a href="{{ url('/'.Auth::user()->getUsername().'/settings/general') }}" class="btn menu-btn"><i class="fa fa-cog" aria-hidden="true"></i>{{ trans('common.settings') }}</a></li>
		</ul>
	</div>
